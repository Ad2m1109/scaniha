    ...
    <Card className="glass-card min-w-0 border-0 p-0 ring-0">
      <CardHeader className="flex flex-row items-start justify-between gap-3 p-5 pb-0 sm:p-6 sm:pb-0">
        ...
        <Button variant="outline" size="icon" type="button" className="icon-button h-9 w-9 rounded-xl bg-surface-soft" aria-label="Open loyalty card" title="Open loyalty card">
          <ExternalLink aria-hidden="true" className="h-4 w-4" style={{ color: 'var(--muted)' }} strokeWidth={1.8} />
        </Button>
      </CardHeader>
      <CardContent className="p-5 pt-4 sm:p-6 sm:pt-5">
        <div className="loyalty-card rounded-2xl p-5 sm:p-6">
          <div className="relative z-10 flex items-start justify-between gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[13px] font-bold tracking-[-.02em]" style={{ color: '#FFFFFF' }}>{business.name}</span>
            </div>
          ...
          <div className="relative z-10 mt-8 flex items-end justify-between gap-4">
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-[.16em]" style={{ color: 'rgba(255, 255, 255, 0.95)' }}>{selectedMember.name}</p>
              <p className="mt-1 text-[11px]" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Member since Jan 2024</p>
            </div>
            <div className="text-right">
              <p className="text-[10px] uppercase tracking-[.13em]" style={{ color: 'rgba(255, 255, 255, 0.95)' }}>Balance</p>
              <p className="numeric mt-1 text-xl font-bold tracking-[-.04em]" style={{ color: '#FFFFFF' }}>
                {formatNumber(selectedMember.points)} <span className="text-[10px] font-semibold" style={{ color: 'rgba(255, 255, 255, 0.85)' }}>pts</span>
              </p>
            </div>
          </div>
        ...
        <div className="mt-4 flex items-center gap-2 text-[11px] font-semibold" style={{ color: 'var(--muted)' }}>
