      ...
      <div className="relative z-10 grid gap-8 xl:grid-cols-[minmax(0,1fr)_320px] xl:items-center">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge className="h-auto rounded-full border border-line bg-white px-3 py-1.5 text-[11px] font-semibold text-purple-dark">
              This month
            </Badge>
          </div>
          <h2 className="mt-5 max-w-lg text-[25px] font-bold leading-[1.12] tracking-[-.045em] text-white sm:text-[30px]">
          ...
          <div className="mt-7 max-w-xl">
            <div className="flex items-center justify-between gap-4 text-[11px] font-semibold text-white/85">
              <span>Member goal progress</span>
              <span className="numeric text-white">
                {formatNumber(data.customers.length)} <span className="font-normal text-white/75">/ {formatNumber(business.memberGoal)} members</span>
              </span>
            </div>
            <Progress
            ...
            />
            <div className="mt-2 flex items-center justify-between gap-4 text-[10px] font-semibold text-white/75">
        ...
        <div className="soft-glass rounded-2xl border-line bg-white p-5 shadow-sm">
          <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-[.16em] text-purple-dark">
            <span>Active members</span>
            <ArrowUpRight aria-hidden="true" className="h-4 w-4 text-purple" strokeWidth={1.8} />
          </div>
          <div className="mt-3 flex items-end gap-3">
            <p className="numeric text-[42px] font-bold leading-none tracking-[-.06em] text-purple-dark">{formatNumber(data.customers.length)}</p>
          ...
          <div className="mt-3 flex items-center justify-between text-[11px] font-semibold">
            ...
            <span className="numeric text-purple-dark">
